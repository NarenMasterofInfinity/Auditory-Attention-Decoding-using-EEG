# Auditory-Attention-Decoding-using-EEG
...
1. git clone "repo".
2. git checkout -b "branch\_name".
3. make your changes here and commit.
4. git push origin branch\_name.
...
3. Run test\_helper.py to make sure everything works as expected. Make sure that the 'PREPROC\_DIR' path is properly set in that file.
