...
# ---------- 3) (Commented) GraphEncoder-only box plot ----------
...
print("\nModel Performance Summary (Pearson r):")
print("-" * 50)
for name, vals in models.items():
    print(f"{name:<20} Mean: {np.mean(vals):.4f} | Median: {np.median(vals):.4f}")

# ---------- 6) (Commented) Save plots ----------
